...
#матрица-столбец правых частей системы ограничений, она же матрица условий, технологическая матрица или матрица норм расхода (по ситуации)
a = np.array([
    [1., 0., 2., 1., 1., 0., 0.],
    [0., 1., 3., 2., 0., 1., 0.],
    [4., 2., 0., 4., 0., 0., 1.]
...
# флаг печати таблиц после каждой итерации???и где он испльзуется
PRNT_DBG = True
